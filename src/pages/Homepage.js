      ...
      <div className="Homepage-container">
        <div className="welcome-section container">
          <div className="Homepage-content">
            <h1>
              <span className="Homepage-content-title">
                Strategic Organizational Development Solutions
              </span>
            </h1>
            <p className="Homepage-content-text">
              ...
              <strong>
                {" "}
                <i className="tag-name">Moore Advanced Solutions</i>
              </strong>{" "}
              provides tailored consulting services to higher education
              institutions and for-profit and non-profit organizations.
            </p>
          ...
          <div className="Homepage-image">
            <img
              src="./assets/images/kevin-matos-Nl_FMFpXo2g-unsplash.jpg"
              alt=""
            />
          </div>
        </div>
        ...
        <section className="about-us container">
          <div className="about-us-image">
            <img
              src="./assets/images/christina-wocintechchat-com-c6wbSBaYxkY-unsplash.jpg"
              alt=""
              width={"700"}
              height={"500"}
            />
          ...
          <div className="about-us-content">
            ...
            <p>
              <strong>
                <i>Moore Advanced Solutions</i>
              </strong>{" "}
              provides consulting services to higher education institutions and
              for-profit and non-profit organizations to create and improve
              their organizational effectiveness. Primary areas of focus
              include: academic accreditation and regulatory affairs; board
              governance and development; organizational capacity building; and
              strategic planning, development, implementation, and assessment.
            </p>
          </div>
        </section>

        {/* Moore Advanced Solutions process */}
        <section className="what-we-do container">
          <div className="punchline">
            <p>
              ...
              The goal at{" "}
              <strong>
                <i className="tagline">Moore Advanced Solutions</i>
              </strong>{" "}
              is to create a positive consulting experience for all clients. The
              foundation of client relationships is grounded in listening and
              collaborating with clients to develop realistic recommendations
              and solutions to meet their organizational needs.
            </p>
          </div>
          <div className="step-exp">
            <h2>A Streamlined and Simple Process</h2>
          </div>
          <div className="steps">
            <div className="step">
              <img
            ...
            <div className="step">
              <img
                src="./assets/images/christina-wocintechchat-com-rg1y72eKw6o-unsplash.jpg"
                alt=""
              />
              <h2>Goal setting</h2>
            ...
            <div className="step">
              <img
                src="./assets/images/glenn-carstens-peters-RLw-UC03Gwc-unsplash.jpg"
                alt=""
              />
              <h2>Planning</h2>
            ...
            <div className="step">
              <img
                src="./assets/images/charles-forerunner-3fPXt37X6UQ-unsplash.jpg"
                alt=""
              />
              <h2>Evaluation</h2>
              <p>
                Evalution of project and implementation of improvement efforts
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="services-offered-list">
            <div className="card">
              <div className="card__image">
                <img
                  src="./assets/icons/graduation.png"
                  alt="S"
                  height={"80"}
                  width={"80"}
                />
              ...
              <div className="card__copy">
                ...
                <br></br>
                <p>
                  Strategic support for organizations related to the initiation,
                  planning, implementation, and ongoing maintenance of
                  accreditation
                </p>
            ...
            <div className="card main-service">
              ...
              <div className="card__copy">
                ...
                <br></br>
                <p>
                  Overall assistance with various elements of organizational
                  effectiveness from strategic planning to organizational
                  capacity building
                </p>
